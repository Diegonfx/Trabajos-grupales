...
public class Tester {
    public static void main(String[] args) {
       ...
       /* bankRTC_SimulationA.opens();
        ...
        for (int i = 0; i < bankRTC_SimulationB.getListOfClients().size(); i++) {
            System.out.println("\n" + bankRTC_SimulationB.getListOfClients().get(i).getName() +
                    "\n Time it was attended: " + bankRTC_SimulationB.getListOfClients().get(i).getAttendedTime() +
                    "\n Time it entered the bank: " + bankRTC_SimulationB.getListOfClients().get(i).getEnterTime() +
                    "\n Time it left the bank: " + bankRTC_SimulationB.getListOfClients().get(i).getExitTime() + timeAfterClose +
                    "\n Time it spent with cashier: " + bankRTC_SimulationB.getListOfClients().get(i).getTimeWithCashier());
        }
